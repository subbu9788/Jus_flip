...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        remoteMessage.data.isNotEmpty().let {
            ...
            /*val action = map[ParamKey.ACTION]
            val seen = map[ParamKey.SEEN]
            val timestamp = map[ParamKey.TIME_STAMP]
            val title = map[ParamKey.TITLE]*/
            val message = map[ParamKey.MESSAGE]
    ...
    private fun scheduleJob() {
        ...
        Log.d(TAG, "Short lived task is done. scheduleJob")
        // [END dispatch_job]
